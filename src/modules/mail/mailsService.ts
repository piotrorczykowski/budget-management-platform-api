...
export default class MailsService {
    ...
    public async sendResetPasswordMail(to: string, token: string): Promise<void> {
        ...
        const mailData: any = {
            ...
            <p style="color: black;">We're sending you this email because you requested a password reset.<br>In order to reset your password, please click the link below.</p>

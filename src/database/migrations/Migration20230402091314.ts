...
export class Migration20230402091314 extends Migration {
    async up(): Promise<void> {
        this.addSql(
            'create table `user` (`id` int unsigned not null auto_increment primary key, `created_at` datetime not null, `updated_at` datetime not null, `username` varchar(30) not null, `first_name` varchar(50) not null, `last_name` varchar(80) not null, `email` varchar(50) not null, `password` varchar(50) not null, `role` tinyint not null) default character set utf8mb4 engine = InnoDB;'
        )
        this.addSql(
